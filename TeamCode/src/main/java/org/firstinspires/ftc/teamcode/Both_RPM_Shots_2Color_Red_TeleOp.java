...
import java.util.List;
 ...
 @TeleOp(name = "Both_RPM_Shots_2Color_Red_TeleOp", group = "TeleOp")
 public class Both_RPM_Shots_2Color_Red_TeleOp extends LinearOpMode {
     ...
     private static final double SHOOTER_READY_MAX_WAIT_SEC = 3.0;
 ...
 //
     ...
     private boolean rpmReadyToShoot() {
         return (Shooter_Speed > 933
                 && Math.abs(Shooter_Speed - Rightshooter.getVelocity()) <=20
                 && Math.abs(Shooter_Speed - Leftshooter.getVelocity()) <= 20);   //was 94
     }
